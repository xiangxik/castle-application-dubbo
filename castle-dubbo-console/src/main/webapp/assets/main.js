...
requirejs.config({
	paths : {
		...
		datetimepicker_base : assetsPath + "vendor/datetimepicker/js/bootstrap-datetimepicker.min",
		datetimepicker : assetsPath + "vendor/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN",
	...
	shim : {
		...
		demo : [ "adminlte" ],
		datetimepicker_base : [ "bootstrap",
				"css!" + assetsPath + "vendor/datetimepicker/css/bootstrap-datetimepicker.min.css" ],
		datetimepicker : [ "datetimepicker_base" ],
